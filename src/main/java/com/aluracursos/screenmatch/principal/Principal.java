...
public class Principal {
    ...
    private final String API_KEY = "&apikey=1b38677f";
    ...
    public void muestraElMenu() {
        ...
        while (opcion != 0) {
            var menu = """
                    ...
                    7 - Buscar series por temporadas y su puntuacion
    ...
    private void buscarSeriesPorCategoria() {
        System.out.println("Escribe el nombre de la categoria/genero que deseas buscar");
    ...
    private void filtrarSeriesPorTemporadaYEvaluacion() {
        System.out.println("¿Cuantas temporadas de series desea filtrar?");
        var totalTemporadas = teclado.nextInt();
        teclado.nextLine();
        System.out.println("¿Que evaluacion de series desea filtrar a partir de que valor?");
